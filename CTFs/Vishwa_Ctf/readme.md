...
![](https://github.com/a3x3k/Bi0s/CTFs/Vishwa_Ctf/Assets/1.png?raw=true)
 - Download the Image given.

![](https://github.com/a3x3k/Bi0s/CTFs/Vishwa_Ctf/Assets/2.jpg?raw=true)

- Use Stegsolve and invert the colors.

![](https://github.com/a3x3k/Bi0s/CTFs/Vishwa_Ctf/Assets/3.png?raw=true)

- This will be the final image which u get.
- Then use `zbarimg` tool to extract text from the `Barcode`.

![](https://github.com/a3x3k/Bi0s/CTFs/Vishwa_Ctf/Assets/4.png?raw=true)
...
![](https://github.com/a3x3k/Bi0s/CTFs/Vishwa_Ctf/Assets/5.png?raw=true)
...
![](https://github.com/a3x3k/Bi0s/CTFs/Vishwa_Ctf/Assets/6.png?raw=true)
...
![](https://github.com/a3x3k/Bi0s/CTFs/Vishwa_Ctf/Assets/7.png?raw=true)

- Download the Image File given.

![](https://github.com/a3x3k/Bi0s/CTFs/Vishwa_Ctf/Assets/8.jpg?raw=true)
...
![](https://github.com/a3x3k/Bi0s/CTFs/Vishwa_Ctf/Assets/9.png?raw=true)
...
![](https://github.com/a3x3k/Bi0s/CTFs/Vishwa_Ctf/Assets/10.png?raw=true)

- Download the given `docx` file.
- Use `cat` command with `pipe` and `grep` to see the `contents`.

![](https://github.com/a3x3k/Bi0s/CTFs/Vishwa_Ctf/Assets/12.png?raw=true)
...
![](https://github.com/a3x3k/Bi0s/CTFs/Vishwa_Ctf/Assets/13.png?raw=true)

- Download the given `Audio` File.

![](https://github.com/a3x3k/Bi0s/CTFs/Vishwa_Ctf/Assets/14.png?raw=true)
...
![](https://github.com/a3x3k/Bi0s/CTFs/Vishwa_Ctf/Assets/16.png?raw=true)
...
![](https://github.com/a3x3k/Bi0s/CTFs/Vishwa_Ctf/Assets/19.png?raw=true)
...
![](https://github.com/a3x3k/Bi0s/CTFs/Vishwa_Ctf/Assets/17.png?raw=true)

- `Download` the `files` given.
- Using `registry viewer` `analyse` the file2.
- Go through the `accounts` folder.

![](https://github.com/a3x3k/Bi0s/CTFs/Vishwa_Ctf/Assets/21.png?raw=true)
...
![](https://github.com/a3x3k/Bi0s/CTFs/Vishwa_Ctf/Assets/20.png?raw=true)
...
![](https://github.com/a3x3k/Bi0s/CTFs/Vishwa_Ctf/Assets/23.png?raw=true)
